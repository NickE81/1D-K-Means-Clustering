...
The first is the iterative file, which shows the iterative process of the K-Means algorithm (1. Randomly assign centres as sample from inputs 2. Assign inputs to clusters based on the nearly existing centre 3. Move4. repeat).
